...
WorldAxis::WorldAxis()
{
    ...
    mVertices.push_back(Vertex{ 0.f, 0.f+i, 0.f,     0.25f, 0.75f, 0.f,    0.f, 0.f }); //x-axis
    mVertices.push_back(Vertex{ 20.f, 0.f+i, 0.f,     1.f, 0.f, 0.f,    0.f, 0.f });
    mVertices.push_back(Vertex{ 0.f+i, 0.f, 0.f,     0.75f, 0.25f, 0.f,    0.f, 0.f }); //y-axis
    mVertices.push_back(Vertex{ 0.f+i, 20.f, 0.f,     0.f, 1.f, 0.f,    0.f, 0.f });
    }
